  ...
  async handleLogin(event) {
    ...
    if (this.blockedForm === false) {
      ...
      if (response.logged == false) {
        this.error =
          "Bad username or password. Please try again using correct credentials.";
        this.setState({
          rerenderKey: this.state.rerenderKey + 1,
        });
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                <form
                  ...
                  method="post"
                  action="#"
                  style={{ display: this.logged ? "none" : "initial" }}
                ...
                >
                  ...
                  <div className="wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <div
                      ...
                      style={{
                        display: this.error != "" ? "initial" : "none",
                        marginBottom: "10px",
                      }}
                    >
                ...
                <form
                  id="appointment=form"
                  role="form"
                  style={{ display: this.logged ? "initial" : "none" }}
                >
                  <div
                    className="section-title wow fadeInUp"
                    data-wow-delay="0.4s"
