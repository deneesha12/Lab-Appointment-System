...
class ProfilePage extends React.Component {
  ...
  async cancelAppointment(event) {
    ...
    if (response.status === 100 || response.status === 200) {
      ...
      toast.error(
        "Error occured on server side. Please contact with your Administrator!",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
              ...
              <div className="col-md-6 col-sm-6" key={this.state.rerenderKey}>
                <div className="team-info">
                  ...
                  <div className="team-contact-info">
                    ...
                    <EditableInput
                      ...
                      name="birthDate"
                      label="Birth Date"
                      value={this.userData.birthDate.split("T")[0]}
                      required={true}
                    />
                    <EditableInput
                      alterData={this.alterData}
                ...
                <div className="team-info">
                  ...
                  <EditableInput
                    ...
                    label="Street"
                    name="address.street"
                    value={this.userData.address.street}
                    required={true}
                  />
                  <EditableInput
                    alterData={this.alterData}
                    ...
                    value={this.userData.address.postalCode}
                    required={true}
                  />
                  <EditableInput
                    alterData={this.alterData}
                    ...
                    label="City"
                    name="address.city"
                    value={this.userData.address.city}
                    required={true}
                  />
                  <EditableInput
                    alterData={this.alterData}
                    ...
                    label="State"
                    name="address.state"
                    value={this.userData.address.state}
                  />
                  <EditableInput
                    alterData={this.alterData}
                    type="text"
                    ...
                    value={this.userData.address.country}
                    required={true}
                  />
                  <h3 style={{ display: "inline-block", marginTop: "20px" }}>
