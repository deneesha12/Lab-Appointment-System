...
class RegisterPage extends React.Component {
  ...
  handleValidation(form) {
    ...
    if (!atLeastOneAlphabeticalLowerChar.test(formFields["password"].value)) {
      errors.password =
        "Password needs to contain at least one lowercase alphabetical character";
      formFields["password"].setCustomValidity(errors.password);
      formFields["password"].reportValidity();
    } else if (
      !atLeastOneAlphabeticalUpperChar.test(formFields["password"].value)
    ) {
      errors.password =
        "Password needs to contain at least one uppercase alphabetical character";
      formFields["password"].setCustomValidity(errors.password);
      formFields["password"].reportValidity();
      ...
      formFields["password"].value !== formFields["confirm-password"].value
    ) {
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6" key={this.state.rerenderKey}>
                ...
                >
                  ...
                  >
                    <h2>
                      Thank you for registering! Now you'll be redirected to
                      login page...
                    </h2>
                  </div>
                </form>
